            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="h5 mb-0 font-weight-bold text-gray-800">Exit Data Survei</div>
                        <div class="pt-5">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        if ($ds['id_jenis_survei']==2) { ?>
                                            ...
                                            <td>
                                                <?php if ($ds['model_survei']==1) {
                                                    echo "Pendidikan";
                                                }if ($ds['model_survei']==2) {
                                                    echo "Fasilitas Mahasiswa";
                                                }if ($ds['model_survei']==3) {
                                                    echo "Manajemen";
                                                }if ($ds['model_survei']==4) {
                                                    echo "Kompetensi";
                                                }
